	...
	<div class="navbar yamm navbar-default">
     ...
     <div class="navbar-header">
      ...
      <ul class="nav navbar-nav three">
		...
		<li class="dropdown"><a href="#" >Manage Your Profile</a>
...
<div id="psdg-header">
<span class="psdg-bold">Your Profile</span><br />
...
$select = "SELECT * FROM author_details WHERE author_email = :email";
        ...
        $posts = $statement->fetch();
?>
<div class="psdg-left">First Name</div>

<?php
echo "<div class='psdg-right'>";
echo $posts['author_firstName'];
echo "</div>";
?>
<div class="psdg-left">Last Name </div>
<?php
echo "<div class='psdg-right'>";
echo $posts['author_lastName'];
echo "</div>";
...
<div class="psdg-left">Email</div>
<?php
echo "<div class='psdg-right'>";
echo $posts['author_email'];
...
?>
  ...
  <div id="psdg-bottom">
<div class="psdg-bottom-cell" ><a href="update.php">Click Here For Edit Your Profile</a></div>
