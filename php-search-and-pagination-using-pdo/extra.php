     ...
     <div class="navbar-header">
      ...
      <div id="navbar-collapse-1" class="navbar-collapse collapse">
       ...
       <li class="dropdown"> <a href="logout.php">Logout</a></li>
        ...
        <div style='text-align:right;margin-top:-40px;float: right'><input type='text' placeholder="Search..." name='search[keyword]' value="<?php echo $search_keyword; ?>" id='keyword' maxlength='25'></div>
    </form>
...
<tr><th>Article Title</th>  </tr> </thead>
...
require('connect.php');
        ...
        $select1 = "SELECT * FROM article_details WHERE author_id = :id";
        $statement1 = $db->prepare($select1);
        $statement1->bindValue(':id', $aid);
        $statement1->execute(); 
...
<?php foreach($posts1 as $post): ?>
    <tr><td>
        <a href="edit.php?id=<?= $post['article_id'] ?>"><?= $post['article_title'] ?></a>
</td></tr>
 <?php endforeach ?> 
</tbody>
</table>
