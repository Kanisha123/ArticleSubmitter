	...
	<div class="navbar yamm navbar-default">
     ...
     <div class="navbar-header">
      ...
      <div id="navbar-collapse-1" class="navbar-collapse collapse">
        ...
        <li class="dropdown"><a href="#">Submit Your Article</a>
...
<form id="sky-form" class="sky-form" method="post" action="article.php" enctype='multipart/form-data'>
            ...
            <fieldset>					
				...
				<label class="input">
                    	<input type="text" name="Title" placeholder="Article Title" maxlength="70" title="Title Of Article" required />
		</label>		
		</section>
		...
		<label class="textarea"> 
                <textarea rows="25" name="Body" id="Body" placeholder="Article Body" minlength="" required/></textarea>
              </label>
			...
			<button type="reset" class="button button-secondary">Reset</button>
                ...
                <button type="submit" name="submit" value="login" class="button">Submit Article</button>
                </div>
