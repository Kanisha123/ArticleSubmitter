	...
	<div class="navbar yamm navbar-default">
     ...
     <div class="navbar-header">
      ...
      <div id="navbar-collapse-1" class="navbar-collapse collapse">
        ...
        <li class="dropdown"><a href="index.php"><i class="fa fa-home ">  </i> Home </a></li>
...
<div class="container">
	...
	<div class="reg_form">
        <form name="frm1"  method="post" id="sky-form" class="sky-form" action="pupdate.php">
				...
				<fieldset>					
					...
					<div class="row">
						<section class="col col-6">
							<label class="input">
								...
								<input type="text" name="FirstName" placeholder="First name" value="<?= $posts['author_firstName'] ?>" pattern="[a-zA-Z]{3,20}" title="Enter First Name" required/>
							</label>
						</section>
						<section class="col col-6">
							<label class="input">
								<input type="text" name="LastName" placeholder="Last name" value="<?= $posts['author_lastName'] ?>" pattern="[a-zA-Z]{3,30}" title="Enter Last Name" required />
							</label>
						</section>
					</div>
					...
					<section>
						<label class="input">
							...
							<input type="email" name="Email" placeholder="Email address" value="<?= $posts['author_email'] ?>" title="Plaese Enter your Email Address" required />
							<!-- <b class="tooltip tooltip-bottom-right">Needed to verify your account</b> -->
						</label>
					</section>
					<input type="hidden" name="id" value="<?= $posts['author_id'] ?>" />
